  ...
  return (
    <View className="flex-1  w-full bg-gray-100 p-4">
      ...
      <View className="mt-5 space-y-6">
        <TextInput
          className="border border-gray-300 rounded-[20px] p-3 mb-4 bg-white"
        ...
        />
        <TextInput
          className="border border-gray-300 rounded-[20px] p-3 bg-white"
      ...
      {/* Reschedule Button */}
      <TouchableOpacity className="mt-6 p-4 bg-blue-800 rounded-[20px]">
